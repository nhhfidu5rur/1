...
# Determine the shell we are running under.
# CDPATH appears to be used in BASH and should be reset to the default
# within shell scripts.
CDPATH=
case "`echo -n "$BASH_VERSION" | cut -d. -f1`" in
  *)   NONSTOP=true ;;
esac
